...
public class RemoveContainers {
    public void removeContainers(){
        String Line;
        try {
            Scanner scanner1 = new Scanner(new BufferedReader(new FileReader("Containers.csv")));
            ...
            System.out.println("---------------------------------------------------------");
            System.out.println("Which containers do you want to remove?" + "\n Write \"back\" to go back");
            ...
            if (choose.equalsIgnoreCase("back")) {
                ...
                try {
                    ...
                    Scanner scanner2 = new Scanner(new BufferedReader(new FileReader("Containers.csv")));
                    while ((scanner2.hasNextLine())) {
                        ...
                        if (j == -1) {
                            ...
                            System.out.println("Container have been removed");
                        }
                    }scanner2.close();
                    BufferedWriter writer = new BufferedWriter(new FileWriter("Containers.csv"));
