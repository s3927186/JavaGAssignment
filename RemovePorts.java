...
public class RemovePorts {
    public void removePorts(){
        String Line;
        try {
            Scanner scanner1 = new Scanner(new BufferedReader(new FileReader("Ports.csv")));
            ...
            System.out.println("---------------------------------------------------------");
            System.out.println("Which port do you want to remove?" + "\n Write \"back\" to go back");
            ...
            if (choose.equalsIgnoreCase("back")) {
                ...
                try {
                    ...
                    Scanner scanner2 = new Scanner(new BufferedReader(new FileReader("Ports.csv")));
                    while ((scanner2.hasNextLine())) {
                        ...
                        if (j == -1) {
                            ...
                            System.out.println("Port have been removed");
                        }
                    }scanner2.close();
                    BufferedWriter writer = new BufferedWriter(new FileWriter("Ports.csv"));
