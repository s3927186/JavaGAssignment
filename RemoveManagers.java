...
public class RemoveManagers {
    public void removeManager(){
        String Line;
        try {
            Scanner scanner1 = new Scanner(new BufferedReader(new FileReader("Manager.csv")));
            ...
            System.out.println("---------------------------------------------------------");
            System.out.println("Which Manager do you want to remove?" + "\n Write \"back\" to go back");
            ...
            if (choose.equalsIgnoreCase("back")) {
                ...
                try {
                    ...
                    Scanner scanner2 = new Scanner(new BufferedReader(new FileReader("Manager.csv")));
                    while ((scanner2.hasNextLine())) {
                        ...
                        if (j == -1) {
                            ...
                            System.out.println("Manager have been removed");
                        }
                    }scanner2.close();
                    BufferedWriter writer = new BufferedWriter(new FileWriter("Manager.csv"));
